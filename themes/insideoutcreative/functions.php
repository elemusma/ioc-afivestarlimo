...
function afivestarlimo_stylesheets() {
...
wp_enqueue_style('coromont', '//use.typekit.net/izq2yvz.css');

}
add_action('wp_enqueue_scripts', 'afivestarlimo_stylesheets');
// for footer
function afivestarlimo_stylesheets_footer() {
	// wp_enqueue_style('style-footer', get_theme_file_uri('/css/style-footer.css'));


	if(!is_page(43) && !is_page(261)){
		// owl carousel
...
add_action('get_footer', 'afivestarlimo_stylesheets_footer');
...
add_action('after_setup_theme', 'afivestarlimo_menus');
